...
GO
/****** Object: Table [dbo].[__MigrationHistory] Script Date: 26/08/2016 16:28:40 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO [dbo].[__MigrationHistory] ([MigrationId], [ContextKey], [Model], [ProductVersion]) VALUES (N'201608261313441_InitialCreate', N'CorsoMVCDatabaseRipasso.Models.ApplicationDbContext', <Binary Data>, N'6.1.3-40302')

INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName]) VALUES (N'339f63d0-6f5e-47a2-84a0-37b4f5126f7c', N'admin@test.it', 0, N'ACUVfmB+P9hGwu5yXh6RoKVPUmHdfqkiDAcgoEXdrvx4/rYbeb6bax7YLoIdoHJmEg==', N'f8ff1d89-9e53-4a51-b6df-aeae7dae312a', NULL, 0, 0, NULL, 1, 0, N'admin@test.it')
